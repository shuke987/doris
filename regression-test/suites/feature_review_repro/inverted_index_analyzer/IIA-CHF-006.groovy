// IIA-CHF-006: char_filter_replacement UTF-8 → FE 拒绝
suite("repro_iia_chf_006") {
    sql "DROP TABLE IF EXISTS t_iia_chf_006"
    boolean threw = false
    try {
        sql """
            CREATE TABLE t_iia_chf_006 (id INT, c TEXT,
    ...
    assertTrue(threw, "FE should reject UTF-8 char_filter_replacement")
    sql "DROP TABLE IF EXISTS t_iia_chf_006"
}
